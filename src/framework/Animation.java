...
public class Animation {
	...
	{
		if ( !animationMode.equals(SINGLE_MODE) && !animationMode.equals(LOOP_MODE) )
...
//==============================================================================
	...
	public void nextFrame()
	{
		...
		if ( !this.mode.equals(SINGLE_MODE) && this.currentFrame == lastFrame )
			return;
	...
	{
		return	this.mode.equals(SINGLE_MODE)					&& 
...
//==============================================================================
	...
	{
		return	this.mode.equals(LOOP_MODE);
	}
	...
	{
		if ( !mode.equals(SINGLE_MODE) && mode.equals(LOOP_MODE) )
			throw new IllegalArgumentException( "Animation mode must be set to either Animation.SINGLE_MODE or Animation.LOOP_MODE");
